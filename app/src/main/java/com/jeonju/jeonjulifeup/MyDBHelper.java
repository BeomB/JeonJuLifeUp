...
public class MyDBHelper extends SQLiteOpenHelper {
    ...
    private static String DB_NAME = "asdasdasdasddsa.db";
    ...
    private void dataBaseCheck() {
        ...
        if (! dbPath.exists() &&  dbPath.mkdir()) {
            Log.d(TAG, "ar data directory created.");
        }
    ...
    private void dbCopy() {
        ...
        try {
            ...
            InputStream inputStream = mContext.getAssets().open("databases/kingigfish.db");
